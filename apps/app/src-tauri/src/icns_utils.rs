...
fn load_icns_file(path: &Path) -> Result<Option<Vec<u8>>, String> {
    ...
    let icon_types = [IconType::RGBA32_256x256, IconType::RGBA32_128x128, IconType::RGBA32_64x64, IconType::RGBA32_32x32];
...
#[command]
#[cfg(target_os = "macos")]
pub fn load_app_icons<R: Runtime>(app_handle: AppHandle<R>, resources_paths: Vec<String>) -> Result<HashMap<String, String>, String> {
