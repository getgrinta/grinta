...
import { onMount } from "svelte";
  import { ACCENT_COLOR, baseCurrencies, LANGUAGE_NATIVE_NAME, SEARCH_ENGINE, SEARCH_ENGINE_STYLED, THEME } from "@getgrinta/core";
...
watch(
	...
	(before, after) => {
		...
		if (before.clipboardRecordingEnabled && !after.clipboardRecordingEnabled) {
