...
<div class="flex flex-1 px-8 py-4 gap-8">
    ...
    <div class="flex flex-col flex-1 gap-4 justify-center">
        <div class="flex flex-col gap-2">
            <label for="language" class="label text-sm">{$_("settings.language")}</label>
            ...
            <label for="accentColor" class="label text-sm">{$_("settings.fields.accentColor")}</label>
            ...
            <label for="searchEngine" class="label text-sm">{$_("settings.fields.defaultSearchEngine")}</label>
            ...
            <label for="toggleShortcut" class="label text-sm">{$_("settings.fields.shortcut")}</label>
            <div class="join">
