...
const topBarCss = systemThemeWatcher.theme === THEME.DARK ? "backdrop-blur-lg bg-base-100/20 border-neutral-800 !outline-none px-6 h-14" : "bg-neutral-300/50 border-neutral-400/30 !shadow-neutral-300/30 !shadow-xs !outline-none px-6 h-14";
