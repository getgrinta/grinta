...
<div class="fixed flex flex-row left-4 top-4 right-4 z-10 items-center gap-2">
  <label class={clsx("input flex-1 flex items-center gap-4 w-full bg-neutral-200/50 border-neutral-400/30 !shadow-neutral-300/30 !shadow-xs !outline-none px-6 h-14", fancyMode && "border-gradient")}>
  	<slot name="indicator">
